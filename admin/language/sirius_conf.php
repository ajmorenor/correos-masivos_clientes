...
# Category Store
$SLNG_CAT_LIST=array();
$SLNG_CAT_LIST["letheglobal"] = array("name"=>"Lethe Global","active"=>"1","isPrimary"=>"1");
$SLNG_CAT_LIST["autoresponder"] = array("name"=>"Autoresponder","active"=>"1","isPrimary"=>"0");
$SLNG_CAT_LIST["newsletter"] = array("name"=>"Newsletter","active"=>"1","isPrimary"=>"0");
$SLNG_CAT_LIST["organizations"] = array("name"=>"Organizations","active"=>"1","isPrimary"=>"0");
$SLNG_CAT_LIST["settings"] = array("name"=>"Settings","active"=>"1","isPrimary"=>"0");
$SLNG_CAT_LIST["subscribers"] = array("name"=>"Subscribers","active"=>"1","isPrimary"=>"0");
$SLNG_CAT_LIST["templates"] = array("name"=>"Templates","active"=>"1","isPrimary"=>"0");
# Cookie Controls
